...
def run_coingecko_example():
    ...
    if not settings.COINGECKO_API_KEY:
        print("COINGECKO_API_KEY not set. Proceeding with public CoinGecko API (rate limits may apply).")    try:
...
if __name__ == "__main__":
    ...
    # that your config.py loads (if you have one).    # e.g., in a .env file at the project root:
    # POLYGON_API_KEY="YOUR_POLYGON_KEY"
    # COINGECKO_API_KEY="YOUR_COINGECKO_KEY" (optional)
    #
    # Alternatively, you can export them in your shell:    # export POLYGON_API_KEY="YOUR_POLYGON_KEY"
